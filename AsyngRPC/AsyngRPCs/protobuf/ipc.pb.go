...
type IpcRequest struct {
	...
	Nsize []byte `protobuf:"bytes,2,opt,name=nsize,proto3" json:"nsize,omitempty"`
}
...
func (x *IpcRequest) GetNsize() []byte {
	if x != nil {
		return x.Nsize
	}
	return nil
...
var file_protobuf_ipc_proto_rawDesc = []byte{
	...
	0x71, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c,
